...
class LanStrZHT(LanStr):
    ...
    NO_UPDATE_FOUND = "未發現更新"
    UNZIPPING = "解壓中..."
    DOWNLOADING = "下載中..."
    UPDATE_PREPARED = "更新已準備好。點擊按鈕更新並重啟。"    
    
    # Settings
    SAVE = "儲存"
    CANCEL = "取消"
    SETTINGS_TIPS = "MITM 代理相關設置項重啟後生效"
    MITM_PORT = "MITM 服務端口"
    UPSTREAM_PROXY = "上游PROXY"
    CLIENT_SIZE = "客戶端大小"
    MAJSOUL_URL = "雀魂網址"
    ENABLE_CHROME_EXT = "啟用瀏覽器擴充功能"
    LANGUAGE = "顯示語言"
    CLIENT_INJECT_PROXY = "自動代理雀魂 Windows 客戶端" 
    MODEL_TYPE = "AI 模型類型"
    AI_MODEL_FILE = "本地模型文件（四麻）"
    AI_MODEL_FILE_3P = "本地模型文件（三麻）"
    AKAGI_OT_URL = "AkagiOT 伺服器地址"
    AKAGI_OT_APIKEY = "AkagiOT API Key"
    MJAPI_URL = "MJAPI 伺服器地址"
    MJAPI_USER = "MJAPI 用戶名"
    MJAPI_USAGE = "API 用量"
    MJAPI_SECRET = "MJAPI 密鑰"
    MJAPI_MODEL_SELECT = "MJAPI 模型選擇"
    LOGIN_TO_REFRESH = "登錄後更新"
    AUTO_LAUNCH_BROWSER = "自動啟動瀏覽器"
    MITM_PORT_ERROR_PROMPT = "錯誤的 MITM 服務端口(必須是1000~65535)"
    # autoplay
    AUTO_PLAY_SETTINGS = "自動打牌設定"
    AUTO_IDLE_MOVE = "滑鼠空閒移動"
    DRAG_DAHAI = "滑鼠拖拽出牌"
    RANDOM_CHOICE = "AI 選項隨機化（去重）"
    REPLY_EMOJI_CHANCE = "回應表情機率"
    ...
    MITM_CERT_NOT_INSTALLED = "以管理員執行或手動安裝 MITM 證書"
    MITM_SERVER_ERROR = "MITM 服務錯誤!"
    MAIN_THREAD_ERROR = "主進程發生錯誤!"
    MODEL_NOT_SUPPORT_MODE_ERROR = "模型不支持遊戲模式"
    CONNECTION_ERROR = "網絡連接錯誤"
    BROWSER_ZOOM_OFF = r"請將瀏覽器縮放設置成 100% 以正常運行!"
    CHECK_ZOOM = "瀏覽器縮放錯誤!"
    ...
    MJAI_2_STR ={
        ...
        'C': '中', 'F': '發', 'P': '白',
        '5mr': '赤伍萬', '5pr': '赤伍筒', '5sr': '赤伍索', 
        'reach': '立直', 'chi_low': '吃-低', 'chi_mid': '吃-中', 'chi_high': '吃-高', 'pon': '碰', 'kan_select':'槓',
        'hora': '和牌', 'ryukyoku': '流局', 'none': '跳過', 'nukidora':'拔北'
    }
